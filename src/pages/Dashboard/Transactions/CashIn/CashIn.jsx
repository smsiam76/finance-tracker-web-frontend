  ...
  return (
    ...
    >
      <form
        ...
        className="w-full md:max-w-1/2 bg-white rounded-2xl p-4 shadow-xl space-y-5"
      >
        ...
        <div>
          <div className="bg-primary/5 border border-primary/40 rounded-xl p-3">
        ...
        <button
          ...
          className="w-full bg-primary hover:bg-emerald-900 disabled:opacity-50 font-semibold py-2.5 rounded-xl transition shadow-lg shadow-emerald-950/20 cursor-pointer text-white"
        >
          Cash In
        </button>
