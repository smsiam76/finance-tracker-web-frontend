      ...
      >
        ...
        <div>
          <div className="bg-red-50 border border-red-200 rounded-xl p-3">
            <label className="text-xs text-red-600 block mb-1 font-bold">
              Amount (BDT)
            </label>
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-red-500 hover:text-white p-2 rounded-lg hover:bg-red-500 transition-all duration-300 ease-linear cursor-pointer"
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <button
              type="button"
              onClick={() =>
                document.getElementById("create_book_modal_cashout").showModal()
              }
          ...
          {books.length === 0 ? (
            <div className="text-center py-4 bg-gray-50 rounded-xl border border-dashed border-gray-300">
              ...
              <button
                ...
                onClick={() =>
                  document
                    .getElementById("create_book_modal_cashout")
                    .showModal()
                }
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-sm text-gray-700 focus:outline-none focus:border-red-500"
          />
          {errors.date && (
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-red-500 placeholder-gray-400"
          />
          {errors.note && (
        ...
        <div>
          ...
          {receiptPreview ? (
            ...
            <label className="flex items-center gap-2 border border-dashed border-gray-300 bg-gray-50 p-2.5 rounded-xl text-xs text-gray-600 hover:border-red-500 hover:text-red-500 transition cursor-pointer w-max">
              {uploading ? (
                <>
        ...
        <button
          ...
          className="w-full bg-red-500 hover:bg-red-600 disabled:opacity-50 font-semibold py-3 rounded-xl transition shadow-md text-white cursor-pointer"
        >
          {isCreating ? "Processing..." : "Cash Out"}
        </button>
      </form>
